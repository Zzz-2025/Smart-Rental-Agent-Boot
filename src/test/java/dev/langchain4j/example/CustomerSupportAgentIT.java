...
class CustomerSupportAgentIT {
    ...
    private static final String EMPLOYER_NAME = "John Doe";
    private static final String EMPLOYER_PHONE = "13245685212";
    private static final String EMPLOYER_ID_NUMBER = "441521200110121456";
    private static final String LICENSE_PLATE = "粤A11223";
    private static final String VEHICLE_TYPE = "丰田SUV";
    private static final String RENTAL_LOCATION = "洛圣都租车行";
    ...
    void setUp() {
        ...
        Booking booking = new Booking(BOOKING_NUMBER, BOOKING_BEGIN_DATE, BOOKING_END_DATE, customer,
                LICENSE_PLATE, VEHICLE_TYPE, RENTAL_LOCATION);
        when(bookingService.getBookingDetailsByPhone(BOOKING_NUMBER, EMPLOYER_PHONE)).thenReturn(booking);
    ...
    void should_provide_booking_details_for_existing_booking() {
        ...
        // given
        String userMessage = "Hi, my phone number is %s. When does my booking %s start?"
        ...
        verify(bookingService).getBookingDetailsByPhone(BOOKING_NUMBER, EMPLOYER_PHONE);
    ...
    void should_not_provide_booking_details_when_booking_does_not_exist() {
        ...
        assertThat(result).onlyToolWasExecuted("getBookingDetailsByPhone");
        verify(bookingService).getBookingDetailsByPhone(invalidBookingNumber, EMPLOYER_PHONE);
        verifyNoMoreInteractions(bookingService);
    ...
    void should_not_provide_booking_details_when_not_enough_data_is_provided() {
        ...
        with(judgeModel).assertThat(answer).satisfies(
                "asks user to provide their phone number or ID number",
                "does not mention any dates"
        );
    }
    ...
    void should_cancel_booking() {
        ...
        // given
        String userMessage = "Cancel my booking %s. My phone number is %s."
        ...
        assertThat(result2).onlyToolWasExecuted("cancelBookingByPhone");
        verify(bookingService).cancelBookingByPhone(BOOKING_NUMBER, EMPLOYER_PHONE);
        verifyNoMoreInteractions(bookingService);
    }
